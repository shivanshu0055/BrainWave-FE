  ...
  return (
    <div className='w-[93%] mx-auto md:w-[63%] lg:w-[43%]' >
        <div className='flex gap-3 '>
          <div className='bg-genericBlack/50 inset-shadow-sm inset-shadow-white justify-center items-center rounded-2xl w-fit silverGradient2  cursor-pointer hover:scale-x-104 hover:scale-y-104 duration-600 flex hover:border hover:border-blue-400'>
          ...
          <input ref={queryTab} placeholder='Question your brain and let AI answer the question ...' className='bg-[#4a494d]/50 caret-white inset-shadow-sm inset-shadow-white rounded-2xl h-11 w-full text-white/60 px-3 text-sm outline-none silverGradient2 hover:scale-x-101 hover:scale-y-102 duration-600 hover:border hover:border-blue-400' onInput={()=>{queryTab.current.scrollLeft=queryTab.current.scrollWidth}} type="text" name="" id="" />
          </div>
