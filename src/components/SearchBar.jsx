  ...
  return (
    <div className='w-[93%] mx-auto md:w-[63%] lg:w-[43%]' >
        <div className='flex gap-3 '>
          ...
          <input spellCheck="false" ref={queryTab} placeholder='Search and ask AI about your memories ...' className=' bg-[#4a494d]/40  caret-white inset-shadow-sm inset-shadow-white rounded-2xl h-11 w-full text-white/70 px-3 text-sm outline-none hover:scale-x-101 hover:scale-y-102 duration-600 hover:border hover:border-blue-400 font-inter' type="text" name="" id="" />
          </div>
          <div className='hover:border hover:border-blue-400 bg-blackStandard text-white/80 mt-3 inset-shadow-sm inset-shadow-white h-fit py-2 rounded-2xl mx-auto px-2 text-center font-bold tracking-wider text-xl cursor-pointer hover:scale-x-103 hover:scale-y-102 duration-600' onClick={()=>setModalOpen((prev)=>!prev)}>
              ADD A NEW MEMORY 💨
          </div>
        </div>
  )
